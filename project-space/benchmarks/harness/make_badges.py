...
DEFAULT_BADGES_DIR = pathlib.Path("project-space/dashboards/badges")
...
def main():
    src = pathlib.Path(os.environ.get("BENCH_RESULTS_JSONL", str(DEFAULT_RESULTS)))
    badge_dir = pathlib.Path(os.environ.get("BENCH_BADGES_DIR", str(DEFAULT_BADGES_DIR)))
